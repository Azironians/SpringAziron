...
public final class DevourerHeroModule extends AbstractModule {
    ...
    protected final void configure() {
        final String heroPropertyPath = "./src/main/java/heroes/devourer/hero/properties/hero.properties";
        final String skillPropertyPath = "./src/main/java/heroes/devourer/skills/properties/skills.properties";
