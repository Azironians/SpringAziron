...
public final class LVHeroModule extends AbstractModule{
    ...
    protected final void configure() {
        final String heroPropertyPath = "./src/main/java/heroes/lv/hero/properties/hero.properties";
        final String skillPropertyPath = "./src/main/java/heroes/lv/skills/properties/skills.properties";
