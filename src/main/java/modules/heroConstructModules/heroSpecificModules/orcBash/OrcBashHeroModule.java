...
public final class OrcBashHeroModule extends AbstractModule{
    ...
    protected final void configure() {
        final String heroPropertyPath = "./src/main/java/heroes/orcBash/hero/properties/hero.properties";
        final String skillPropertyPath = "./src/main/java/heroes/orcBash/skills/properties/skills.properties";
